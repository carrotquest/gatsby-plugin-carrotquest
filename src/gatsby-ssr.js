...
exports.onRenderBody = ({ setHeadComponents }, { carrotquestId, mobileDelay = 0, desktopDelay = 0 }) => {
  ...
  const scriptInnerHTML =
    ...
    `function initCQ() {  var s = document.createElement("script");  s.type = "text/javascript";  s.async = true;  s.src = "//cdn.carrotquest.io/api.min.js";  var x = document.getElementsByTagName("head")[0];  x.appendChild(s);}` +
    delay;
